...
path_to_dwiconvert=r"C:\Program Files\Slicer 4.10.1\lib\Slicer-4.10\cli-modules"
...
path_to_dicoms = r"E:\THESIS\Private_DB_Moscow_ORInConverted\CT Scan RAW\DICOM"
# Path to the folder that contains the LIDC-IDRI XML files
# path_to_xmls= r"D:\XML_Revision"
path_to_xmls= r"E:\0.NEW_LEAF.0\CSV and XML\XML\XML_Results_Full"
...
def create_nrrd_from_dicoms(image, patient_id):
    ...
    # print(cmd_string)
    a=subprocess.Popen(['DWIConvert', '--inputDicomDirectory', image, '--outputVolume', target_name, '--conversionMode DicomToNrrd'], shell=True, cwd=path_to_dwiconvert)
    a.wait()
    return target_name
