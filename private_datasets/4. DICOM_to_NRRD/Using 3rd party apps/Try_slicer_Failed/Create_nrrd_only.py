...
# path_to_dwiconvert="../../../../Slicer-4.10.1-linux-amd64/lib/Slicer-4.10/cli-modules"
...
path_to_dicoms = "../../../../THESIS/Private_DB_Moscow_ORInConverted/CT Scan RAW/DICOM"
# path_to_dicoms = "../../../../Hello"
# Path to the folder that contains the LIDC-IDRI XML files
# path_to_xmls= r"D:\XML_Revision"
path_to_xmls= "../../../../XML_Results_Full"
...
path_to_nrrds =  "../../../../Moscow_NRRD_Output/nrrd_file"
# Output path where the genreated Planar Figures will be saved
# path_to_planars= "/media/ivanwilliam/DATA/Moscow_NRRD_Output/planars"
...
path_to_error_file="../../../../Moscow_NRRD_Output/conversion_error_log.txt"
...
def create_nrrd_from_dicoms(image, patient_id):
    ...
    cmd_string = 'python DICOM_to_NRRD.py' 
    # print(cmd_string)
    a=subprocess.Popen([cmd_string, '-i', image, '-o', target_name], shell=True)
