...
dwiConvertPath = '/media/ivanwilliam/BINUS_DATA/Slicer-4.10.1-linux-amd64/lib/Slicer-4.10/cli-modules/DWIConvert'
sourceDirectory = '/media/ivanwilliam/BINUS_DATA/Hello' 
# sourceDirectory = '/media/ivanwilliam/BINUS_DATA/THESIS/Private_DB_Moscow_ORInConverted/CT Scan RAW/DICOM' 
targetDirectory = '/media/ivanwilliam/BINUS_DATA/Moscow_NRRD_Output/nrrd_file'
